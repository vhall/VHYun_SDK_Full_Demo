    ...
    <Modal :visible="addfileVisible" @close="closeAddFileModal" title="文档列表" width="800px">
      <div class="AddFileBox addFileBox">
        <div class="AddFileBox-h">
          ...
          <div class="right" @click="updateDocList(currentPage || 1)">
            ...
            <el-table :data="tableData" style="width: 100%">
              ...
              <el-table-column prop="process" label="进度">
                <template slot-scope="scope">
                  <div class="process">
                    ...
                    <el-progress :percentage="scope.row.process" :show-text="false"
                                 v-if="scope.row.process > 0 && scope.row.process < 100"></el-progress>
                  </div>
                </template>
              </el-table-column>
              <el-table-column prop="set" label="操作">
                <template slot-scope="scope">
                  ...
                  <span style="margin-left: 10px" class="fileSetSpan" @click="yanshi(scope.row)"
                        v-if="scope.row.process == 100">演示</span>
                </template>
              </el-table-column>
            </el-table>
          </div>
          <div class="pagination">
            <el-pagination layout="prev, pager, next" :total="docsContent" :page-size="5"
                           @current-change="getCurrentPage" :current-page="currentPage"></el-pagination>
          </div>
        </div>
      </div>
    </Modal>
