<template>
  <div class="main-content">
    ...
    <div class="main-modal-full" v-if="showModal">
      <!-- 表单操作(弹出来的)-->
      <MainFromSC @close="onCloseForm" v-if="showForm"/>
      <!-- 设置(弹出来的)-->
...
import MainFromSC from '../shard/modals/MainFromSC'
...
export default {
  ...
  computed: {
    ...
    showModal() {
      return this.showForm || this.showSetting || this.showAnswer || this.showDeviceSelect
    },
    active() {
