<template>
  <div
    class="StreamItem"
    data-component="StreamItemLocal"
  ...
  >
    ...
    <!-- moreInfo -->
    <div class="more-info" v-if="viewStreamId">
      <div class="nickName">
    ...
    <!-- 控制 -->
    <div class="control" v-show="viewStreamId && controlShow">
      <!-- 流控制操作，控制自己 -->
